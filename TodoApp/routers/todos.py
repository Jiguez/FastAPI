...
async def edit_todo_form(request: Request,todo_id: int , title: str = Form(...), description: str = Form(...), priority: int = Form(...),
...
async def delete_todo(request: Request, todo_id: int , db: Session = Depends(get_db)):
    ...
    db.query(models.Todos).filter(models.Todos.id == todo.id).delete()
    db.commit()
