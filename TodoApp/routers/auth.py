...
async def authentication_page(resquest: Request):
...
async def register(resquest: Request):
    return templates.TemplateResponse("register.html",{"request": resquest})
